	...
	return (
		<div className="scrollbar">
			<div className="content">
				<h1 className="page-title page-title__padded">Редактировать:</h1>
				<form onSubmit={handleSubmit(onSubmit)} className="form">
					...
					<div className="flex flex-column mb-20">
						...
						<div>
							<input id="price" className="input" type="tel" {...register("price")} />
						</div>
					...
					<div className="flex flex-column mb-20">
						<label className="mb-4" htmlFor="thumbnail">
							Превью: &nbsp;
					...
					<div className="buttons-row buttons-row_clear mt-30">
						<button className="btn btn_primary">Сохранить</button>
						<button onClick={openConfirmModal} className="btn btn_danger">Удалить</button>
